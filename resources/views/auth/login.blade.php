            ...
            <div class="modal-body">
                ...
                <form class="d_change_password_box_form" method="POST" action="{{ route('user.send-forget-password') }}">
                    ...
                    <div class="d_profile_setting_from_btn">
                        <button class="alzatheme-default-btn" data-text="{{ __('translate.Continue') }}">
...
<header class="site-header signup_header alzatheme-header-section" id="sticky-menu">
    ...
    <div class="alzatheme-header-bottom bg-white">
        <div class="container">
            <nav class="navbar site-navbar">
                ...
                <div class="header-btn header-btn-l1 ms-auto d-none d-xs-inline-flex">
                    <div class="alzatheme-header-icon">
                        ...
                        <a class="alzatheme-default-btn alzatheme-header-btn" href="{{ route('contact-us') }}"
        ...
        <div class="sign_up_right">
            ...
            <form class="sign_up_form seller_login" action="{{ route('user.store-login') }}" method="POST">
                ...
                <div class="sign_up_form_btm">
                    <button class="alzatheme-default-btn" data-text="{{ __('translate.Login') }}" type="submit">

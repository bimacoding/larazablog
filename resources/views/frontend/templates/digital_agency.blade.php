...
@section('front-content')
    ...
    <main>
        ...
        @endphp
        <!-- Start Hero Section -->
        <div class="alzatheme-hero-section7 bg-cover" style="background-image: url({{ asset(getImage($heroContent, 'hero_image')) }})">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 d-flex align-items-center">
                        <div class="alzatheme-hero-content dark-color sm">
                            ...
                            <div class="alzatheme-extra-mt">
                                <div class="alzatheme-btn-wrap">
                                    <a class="alzatheme-default-btn" data-aos="fade-up" data-aos-duration="600"
                                    ...
                                    <a class="alzatheme-default-btn alzatheme-light-btn" data-aos="fade-up"
        ...
        <div class="container">
            <div class="alzatheme-divider color2"></div>
        </div>

        <div class="alzatheme-brand-section2 bg-light1">
            <div class="container">
                <div class="alzatheme-brand-title dark-color">
                        ...
                        <div class="alzatheme-default-content mr40">
                            ...
                            <div class="alzatheme-extra-mt">
                                <div class="alzatheme-iconbox-wrap2">
                                    <div class="alzatheme-iconbox-icon2 bg-white">
                ...
                <div class="row">
                    @if($blogPosts->isNotEmpty())
                        ...
                        <div class="col-xl-6 left-align" data-aos="fade-up" data-aos-duration="600">
                            <div class="alzatheme-blog-wrap bg-white">
                                ...
                                <div class="alzatheme-blog-content padding-medium">
                                    ...
                                    <a class="alzatheme-icon-btn" href="{{ route('blog', $lastPost->slug) }}">
                                        <i class="icon-show ri-arrow-right-line"></i>
                    ...
                    <div class="col-xl-6 right-align">
                        @foreach($blogPosts as $index => $blog)
                            ...
                            <div data-aos="fade-left" data-aos-duration="800">
                                <div class="alzatheme-blog-wrap blog-column">
                                    ...
                                    <div class="alzatheme-blog-content">
                                        ...
                                        <a class="alzatheme-icon-btn" href="{{ route('blog', $blog->slug) }}">
                                            <i class="icon-show ri-arrow-right-line"></i>
                                            <span>{{ __('translate.Learn More') }}</span>
                                            <i class="icon-hide ri-arrow-right-line"></i>
                                        </a>
    ...
    <footer class="alzatheme-footer-section alzatheme-section-padding-top">
        <div class="container">

            <div class="alzatheme-footer-cta-wrap shape-white" >
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-4 d-flex align-items-center justify-content-end">
                        <div class="alzatheme-cta-btn" data-aos="fade-up" data-aos-duration="800">
                            <a class="alzatheme-default-btn alzatheme-white-btn" href="{{ route('contact-us') }}"

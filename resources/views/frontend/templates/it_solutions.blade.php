...
<header class="site-header alzatheme-header-section site-header--menu-right alzatheme-header-two" id="sticky-menu">
    <div class="alzatheme-header-top p-0">
        <div class="container">
...
<div class="alzatheme-hero-section2 bg-cover" style="background-image: url({{ asset(getImage($heroContent, 'hero_image')) }})">
    <div class="container">
        <div class="alzatheme-hero-content center">
            <div class="alzatheme-hero-power">
            ...
            <div class="alzatheme-extra-mt" data-aos="fade-up" data-aos-duration="800">
                <a class="alzatheme-default-btn" href="{{ route('contact-us') }}" data-text="{{ getTranslatedValue($heroContent, 'button_text', $currentLang) }}"><span class="btn-wraper">{{ getTranslatedValue($heroContent, 'button_text', $currentLang) }}</span></a>
            </div>
        </div>
    </div>
</div>
...
<div class="section alzatheme-section-padding-bottom">
    <div class="container">
        ...
        <div class="alzatheme-counter-wrap">
            <div class="alzatheme-counter-data" data-aos="fade-up" data-aos-duration="1600">
                <div class="alzatheme-counter-icon">
            ...
            <div class="alzatheme-counter-data" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_2', $currentLang) }}">
                <div class="alzatheme-counter-icon">
            ...
            <div class="alzatheme-counter-data" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_3', $currentLang) }}">
                <div class="alzatheme-counter-icon">
            ...
            <div class="alzatheme-counter-data" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_4', $currentLang) }}">
                <div class="alzatheme-counter-icon">
...
<div class="section bg-light1 alzatheme-section-padding2">
    <div class="container">
...
<div class="section alzatheme-section-padding">
    ...
    <div class="alzatheme-3column-slider" data-aos="fade-up" data-aos-duration="800">
        ...
        <div class="alzatheme-portfolio-wrap mb-0">
            <div class="alzatheme-portfolio-thumb">
...
<div class="section bg-light1 alzatheme-section-padding5">
...
<div class="section alzatheme-section-padding">
    <div class="container">
        ...
        <div class="alzatheme-center-btn">
            <a class="alzatheme-default-btn" href="{{ route('blogs') }}" data-text="View All Posts">
...
<footer class="alzatheme-footer-section dark-bg alzatheme-section-padding-top">
    <div class="container">
        <div class="alzatheme-infobox-wrap extra-padding">
            <div class="row">
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="500">
                    <a href="tel:{{ $footer->phone }}">
                        <div class="alzatheme-infobox-item">
                            <div class="alzatheme-infobox-icon">
                                <i class="ri-phone-fill"></i>
                            </div>
                            <div class="alzatheme-infobox-data">
        ...
        <div class="alzatheme-footer-top alzatheme-section-padding-bottom">
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="alzatheme-subscription-column">
                        <div class="alzatheme-footer-title">

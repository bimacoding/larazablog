...
@section('new-layout')
    ...
    <!-- START GRID SECTION -->
    <!-- Main Start -->
    <div class="alzatheme-breadcrumb"
                                ...
                                @else
                                    <div class="col-xl-4 col-md-6" data-aos="fade-up"
                                        ...
                                        <div class="alzatheme-portfolio-wrap">
                                            <div class="alzatheme-portfolio-thumb alzatheme-portfolio-thumb-2 alzatheme-portfolio-thumb-main   ">
                                                <img src="{{ asset($project->thumb_image) }}" alt="Image" class="full-img">
                                                <a class="alzatheme-portfolio-btn"
                                    ...
                                    @endforeach
                                        ...
                                        @if($projects->hasPages())
                                            <div class="alzatheme-navigation">
                ...
                <div class="row">
                    @foreach($projects as $project)
                        <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="500">
                            <div class="alzatheme-portfolio-wrap">
                                <div class="alzatheme-portfolio-thumb alzatheme-portfolio-thumb-digital">
                                    <img src="{{ asset($project->thumb_image) }}" alt="Image" class="full-img">
                                    <a class="alzatheme-portfolio-btn"
                                       href="{{ route('portfolio.show', $project->slug) }}">

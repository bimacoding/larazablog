            ...
            @if(config('app.env') === 'DEMO' || $currentTheme === 'all_theme')
                <li class="nav-item nav-item-has-children">
                    ...
                    <ul class="sub-menu" id="submenu-1">
                        ...
                        <li class="sub-menu--item">
                            <a href="{{ route('home', ['theme' => 'landing_page']) }}">
                                <span class="menu-item-text {{ $currentTheme === 'landing_page' ? 'active' : '' }}">Landing Page</span>
                            </a>
                        </li>
                    </ul>
                </li>
            @elseif($currentTheme=='landing_page')
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#shwrms" class="nav-link-item">
                        <span class="menu-item-text active">Show Room</span>
                    </a>
                </li>
            @else
                <li class="nav-item">

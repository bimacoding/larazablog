...
@section('front-content')
    ...
    @php
        ...
        $sloganContent = getContent('slogan.content',true);
        $warrantyContent = getContent('warranty.content',true);
    ...
    {{-- slidder --}}
    <div class="alzatheme-hero-section6 mt-0">
        <div class="alzatheme-hero-slider">
            @foreach($sliders as $slider)
               <div class="alzatheme-hero-slider-item" style="background-image: url({{ asset($slider->image) }})">
                    <div class="container">
                        <div class="alzatheme-hero-content row">
                            <img src="{{ asset($slider->image) }}" alt="xx" class="col-sm-12 col-md-6 col-lg-7" width="50">
                            <div class="position-relative p-4 z-index-1 col-sm-12 col-md-6 col-lg-5 align-content-center">
                                <h3 class="text-white">{{ $slider->translate?->title }}</h3>
                                <h2 class="text-white">{{ $slider->translate?->small_text }}</h2>
                                {{-- <div class="alzatheme-extra-mt">
                                    <a class="alzatheme-default-btn" href="{{ $slider->url }}" data-text="{{ $slider->translate?->button_text }}"><span
    ...
    <div class="section py-4 text-center">
        <!-- Judul utama -->
        <h2 class="fw-bold text-dark" style="text-shadow: 0 2px 4px rgba(0,0,0,0.2); color: #2b2d70;">
        {{getTranslatedValue($sloganContent, 'heading', $currentLang)}}
        </h2>

        <!-- Subjudul -->
        <h2 class="mt-4 fs-5 fw-medium text-dark">
        {{getTranslatedValue($sloganContent, 'title', $currentLang)}}
        </h2>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="alzatheme-default-content ml40">
                        ...
                        <div class="alzatheme-extra-mt">
                            <a class="alzatheme-default-btn" href="{{ route('about-us') }}" data-text="{{ getTranslatedValue($aboutUsContent, 'button_text', $currentLang) }}"><span class="btn-wraper">
    ...
    {{-- why --}}
        ...
        <div class="d-flex justify-content-start justify-content-md-center flex-nowrap overflow-auto gap-4 px-2">

                <!-- Integrity -->
            <div class="flex-shrink-0 text-center" style="width: 220px;">
                <div class="rounded-circle bg-danger d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 100px; height: 100px;">
                    <img data-aos="fade-up" data-aos-duration="600" src="{{ asset(getImage($whychooseContent,'image_1')) }}" alt="xxx" width="50">
                </div>
                <h6 class="fw-bold">{{getTranslatedValue($whychooseContent, 'head_1', $currentLang)}}</h6>
                <p class="small text-muted">{{getTranslatedValue($whychooseContent, 'title_1', $currentLang)}}</p>
                </div>

                <!-- Accountability -->
                <div class="flex-shrink-0 text-center" style="width: 220px;">
                <div class="rounded-circle bg-danger d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 100px; height: 100px;">
                    <img data-aos="fade-up" data-aos-duration="800" src="{{ asset(getImage($whychooseContent,'image_2')) }}" alt="xxx" width="50">
                </div>
                <h6 class="fw-bold">{{getTranslatedValue($whychooseContent, 'head_2', $currentLang)}}</h6>
                <p class="small text-muted">{{getTranslatedValue($whychooseContent, 'title_2', $currentLang)}}</p>
                </div>

                <!-- Respect -->
                <div class="flex-shrink-0 text-center" style="width: 220px;">
                <div class="rounded-circle bg-danger d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 100px; height: 100px;">
                    <img data-aos="fade-up" data-aos-duration="1000" src="{{ asset(getImage($whychooseContent,'image_3')) }}" alt="xxx" width="50">
                </div>
                <h6 class="fw-bold">{{getTranslatedValue($whychooseContent, 'head_3', $currentLang)}}</h6>
                <p class="small text-muted">{{getTranslatedValue($whychooseContent, 'title_3', $currentLang)}}</p>
                </div>

                <!-- Grateful -->
                <div class="flex-shrink-0 text-center" style="width: 220px;">
                <div class="rounded-circle bg-danger d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 100px; height: 100px;">
                    <img data-aos="fade-up" data-aos-duration="1200" src="{{ asset(getImage($whychooseContent,'image_4')) }}" alt="xxx" width="50">
                </div>
                <h6 class="fw-bold">{{getTranslatedValue($whychooseContent, 'head_4', $currentLang)}}</h6>
                <p class="small text-muted">{{getTranslatedValue($whychooseContent, 'title_4', $currentLang)}}</p>
                </div>

                <!-- Enthusiast -->
                <div class="flex-shrink-0 text-center" style="width: 220px;">
                <div class="rounded-circle bg-danger d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 100px; height: 100px;">
                    <img data-aos="fade-up" data-aos-duration="1400" src="{{ asset(getImage($whychooseContent,'image_5')) }}" alt="xxx" width="50">
                </div>
                <h6 class="fw-bold">{{getTranslatedValue($whychooseContent, 'head_5', $currentLang)}}</h6>
                <p class="small text-muted">{{getTranslatedValue($whychooseContent, 'title_5', $currentLang)}}</p>
                </div>
    ...
    {{-- after sales service --}}
        <div class="container py-5">
            <h3 class="fw-bold text-center mb-5">Warranty & After Sales Service</h3>
            <div class="row g-4">
                <!-- Kiri -->
                <div class="col-md-6">
                <div class="d-flex align-items-center p-4 bg-light rounded shadow-sm mb-4">
                    <img src="{{ asset(getImage($warrantyContent,'image_wr_1')) }}" alt="{{getTranslatedValue($warrantyContent, 'head_1', $currentLang)}}" class="me-3" style="width:48px;height:48px;">
                    <div>
                    <h5 class="text-default">{{getTranslatedValue($warrantyContent, 'head_1', $currentLang)}}</h5>
                    <p class="text-secondary mb-0">{{getTranslatedValue($warrantyContent, 'title_1', $currentLang)}}</p>
                    </div>
                </div>
                <div class="d-flex align-items-center p-4 bg-light rounded shadow-sm">
                    <img src="{{ asset(getImage($warrantyContent,'image_wr_2')) }}" alt="{{getTranslatedValue($warrantyContent, 'head_2', $currentLang)}}" class="me-3" style="width:48px;height:48px;">
                    <div>
                    <h5 class="text-default">{{getTranslatedValue($warrantyContent, 'head_2', $currentLang)}}</h5>
                    <p class="text-secondary mb-0">{{getTranslatedValue($warrantyContent, 'title_1', $currentLang)}}</p>
                    </div>
                </div>
                </div>
                ...
                <!-- Kanan -->
                <div class="col-md-6">
                <div class="d-flex align-items-center p-4 bg-light rounded shadow-sm h-100">
                    <img src="{{ asset(getImage($warrantyContent,'image_wr_3')) }}" alt="{{getTranslatedValue($warrantyContent, 'head_3', $currentLang)}}" class="me-3" style="width:48px;height:48px;">
                    <div>
                    <h5 class="text-default">{{getTranslatedValue($warrantyContent, 'head_3', $currentLang)}}</h5>
                    <p class="text-secondary mb-4">{{getTranslatedValue($warrantyContent, 'title_1', $currentLang)}}</p>
                    <h5 class="text-default">{{getTranslatedValue($warrantyContent, 'head_4', $currentLang)}}</h5>
                    <p class="text-secondary mb-0">{{getTranslatedValue($warrantyContent, 'title_1', $currentLang)}}</p>
                    </div>
                </div>
                </div>
    ...
    {{-- authorized --}}
        <div class="container text-center py-5">
            ...
            <h4 class="fw-bold text-uppercase mb-3">Authorized Distributor Of</h4>
            <div class="mb-5">
                <img src="{{asset('/frontend/assets/img/wefone.jpg')}}" alt="WeFone LED Logo" class="img-fluid" style="max-height: 100px;">
                <strong class="d-block text-primary">WeFone LED</strong>
            </div>

            <!-- Success Partner Section -->
            <h4 class="fw-bold text-uppercase mb-4">Success Partner Of</h4>
            <div class="row justify-content-center align-items-center g-4">
                @foreach($partners as $index => $partner)
                    <div class="col-4 col-md-2">
                        <img src="{{asset('storage/'.$partner->thumb_image)}}" alt="{{$partner->website_url}}" class="img-fluid" width="50">
                    </div>
                @endforeach
            </div>
        </div>
    ...
    {{-- showroom --}}
        <div class="container py-5" id="shwrms">

            <div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    {{-- Grid 2 kolom untuk gambar utama --}}
                    <div class="row g-4">

                        @foreach ($showrooms as $showroom)
                            <h3 class="text-center">{{$showroom->title}}</h3>
                            @php
                                $images = explode(',', $showroom->images);
                            @endphp
                            <div class="col-12">
                                <div class="card h-100 shadow-sm">
                                    <a href="{{ asset('storage/' . trim($images[0])) }}" target="_blank">
                                    <img src="{{ asset('storage/' . trim($images[0])) }}" class="card-img-top" alt="Showroom Image">
                                    </a>
                                </div>
                            </div>
                        @endforeach
                            ...
                            @foreach ($showrooms as $showroom)
                                ...
                                @foreach ($images as $image)
                                    <div class="me-3 flex-shrink-0" style="width: 200px;">
                                        ...
                                        <img src="{{ asset('storage/' . trim($image)) }}" class="img-fluid rounded border" alt="Gallery Image">
                                        </a>
                                    </div>
                                @endforeach
                            @endforeach
            ...
            <div class="alzatheme-center-btn">
                        <a class="alzatheme-default-btn" href="{{ route('showrooms') }}" data-text="{{ __('translate.Showroom') }}"><span
                                class="btn-wraper">{{ __('translate.Showroom') }}</span></a>
                    </div>
        </div>
    {{-- end showrooms --}}

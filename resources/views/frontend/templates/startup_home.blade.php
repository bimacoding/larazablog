...
@section('front-content')
    ...
    <header class="site-header alzatheme-header-section header-four" id="sticky-menu">
                ...
                <nav class="navbar site-navbar">
                    ...
                    <div class="header-btn header-btn-l1 ms-auto d-none d-xs-inline-flex">
                        <div class="alzatheme-header-icon">
                            ...
                            @endif
                            <a class="alzatheme-default-btn alzatheme-header-btn" href="{{ route('contact-us') }}" data-text="{{ __('translate.Get in Touch') }}"><span
    ...
    <div class="alzatheme-hero-section4 bg-cover">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="alzatheme-hero-content dark-color">
                        ...
                        <div class="alzatheme-extra-mt">
                            <div class="alzatheme-btn-wrap">
                                <a class="alzatheme-default-btn" href="{{ getTranslatedValue($heroSection,'left_button_url', $currentLang) }}" data-text="{{ getTranslatedValue($heroSection,'left_button_text', $currentLang) }}"><span
                                        class="btn-wraper">{{ getTranslatedValue($heroSection,'left_button_text', $currentLang) }}</span></a>
                                <a class="alzatheme-default-btn alzatheme-light-btn" href="{{ getTranslatedValue($heroSection,'right_button_url', $currentLang) }}" data-text="View Services">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-duration="800">
                    <div class="alzatheme-hero-thumb">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-duration="600">
                    <div class="alzatheme-iconbox-wrap style-two border_all">
                        ...
                        <div class="alzatheme-iconbox-data">
                            ...
                            <a class="alzatheme-icon-btn" href="{{ route('service', $listing->slug) }}"><i class="icon-show ri-arrow-right-line"></i>
    ...
    <div class="section alzatheme-section-padding2 dark-bg alzatheme-pricing">
        <div class="container">
            <div class="alzatheme-section-title center light-color">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="{{ $loop->iteration == 1 ? '500' : ($loop->iteration == 2 ? '700' : '900') }}">
                    <div class="alzatheme-pricing-wrap alzatheme-pricing2 {{ $loop->iteration == 2 ? 'active' : '' }}">
                        <div class="alzatheme-pricing-header">
                            <h4>{{ $package['title'] ?? '' }}</h4>
                        </div>
                        <div class="alzatheme-pricing-price">
                            <h2>${{ $package['price'] ?? '0' }}<span>/{{ __('translate.month') }}</span></h2>
                        </div>
                        <p>{{ $package['description'] ?? '' }}</p>
                        <a class="alzatheme-pricing-btn" href="{{ route('contact-us') }}">{{ __('translate.Select This Plan') }}</a>
                        <div class="alzatheme-pricing-feature">
                            <ul>
    ...
    <footer class="alzatheme-footer-section bg-light1">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-12">
                        <div class="alzatheme-footer-textarea dark-color">
                            ...
                            <p>{{ $footer->about_us }}</p>
                            <div class="alzatheme-footer-info dark-color">
                                <ul>
                                    <li><a href="tel:{{ $footer->phone }}"><i class="ri-phone-fill"></i>{{ $footer->phone }}</a></li>
                                    <li><a href="mailto:{{ $footer->email }}"><i class="ri-mail-fill"></i>{{ $footer->email }}</a></li>
                                </ul>

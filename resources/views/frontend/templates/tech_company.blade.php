...
@section('front-content')
    ...
    <header class="site-header alzatheme-header-section site-header--menu-right alzatheme-header-two" id="sticky-menu">
        <div class="alzatheme-header-top dark-bg3">
            <div class="container">
                ...
                <nav class="navbar site-navbar">
                    ...
                    <div class="header-btn header-btn-l1 ms-auto d-none d-xs-inline-flex">
                        <div class="alzatheme-header-icon">
                            ...
                            <a class="alzatheme-default-btn alzatheme-header-btn" href="{{ route('contact-us') }}" data-text="Get in Touch"><span
    ...
    <div class="alzatheme-hero-section8 bg-cover">
        <div class="container">
            <div class="alzatheme-hero-content center medium">
                ...
                <div class="alzatheme-extra-mt">
                    <div class="alzatheme-btn-wrap center">
                        <a class="alzatheme-default-btn" data-aos="fade-up" data-aos-duration="600" href="{{ getTranslatedValue($heroContent, 'left_button_url', $currentLang) }}"
                        ...
                        <a class="alzatheme-default-btn alzatheme-white-btn" data-aos="fade-up" data-aos-duration="800"
    ...
    <div class="section alzatheme-section-padding">
        <div class="container">
            ...
            <div class="alzatheme-center-btn">
                <a class="alzatheme-default-btn" href="{{ route('blogs') }}" data-text="{{ __('translate.View All Posts') }}">

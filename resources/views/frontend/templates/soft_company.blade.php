...
@section('front-content')
            ...
            <div class="row">
                ...
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="alzatheme-default-content ml40">
                        ...
                        <div class="alzatheme-extra-mt">
                            <a class="alzatheme-default-btn" href="{{ route('about-us') }}" data-text="{{ getTranslatedValue($aboutUsContent, 'button_text', $currentLang) }}"><span
            ...
            <div class="alzatheme-4column-slider2" data-aos="fade-up" data-aos-duration="800">
                @foreach($listings as $listing)
                    ...
                    <div class="alzatheme-iconbox-data">
                        ...
                        <a class="alzatheme-icon-btn" href="{{ route('service', $listing->slug) }}"><i
    ...
    <div class="section alzatheme-section-padding">
        ...
        <div class="alzatheme-4column-slider" data-aos="fade-up" data-aos-duration="800">
            ...
            @foreach($teams as $team)
              <div class="alzatheme-team-wrap border_all mb-0">
    ...
    <div class="section bg-cover alzatheme-section-padding custom_image">
        <div class="container">
            <div class="alzatheme-cta-wrap">
                <div class="alzatheme-cta-content center">
                    ...
                    <div class="alzatheme-extra-mt" data-aos="fade-up" data-aos-duration="800">
                        <a class="alzatheme-default-btn" href="{{ route('contact-us') }}" data-text="{{ getTranslatedValue($ctaContent, 'button_text', $currentLang) }}">
        ...
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-7 col-lg-5 d-flex align-items-center justify-content-end">
                        <div class="alzatheme-title-btn">
                            <a class="alzatheme-default-btn" href="{{ route('blogs') }}" data-text="{{ getTranslatedValue($blogContent, 'button_text', $currentLang) }}"><span
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="600">
                    <div class="alzatheme-blog-wrap border-0 bg-white">
        ...
        <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="600">
                        <a href="tel:{{ $footer->phone }}">
                            <div class="alzatheme-infobox-item light-color">
            ...
            <div class="alzatheme-footer-bottom">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="alzatheme-social-icon-box right-align style-two">
                            <ul>
                                <li>

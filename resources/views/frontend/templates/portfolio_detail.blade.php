...
@section('new-layout')
    ...
    <div class="section alzatheme-section-padding">
        <div class="container">
            ...
            <div class="alzatheme-pd-wrap">
                <div class="row">
                    <div class="col-xl-8 col-lg-7">
                        <div class="alzatheme-pd-thumb" data-aos="fade-up" data-aos-duration="800">
                <img src="{{ asset($project->thumb_image) }}" alt="Dardnak Image">
            </div>
                        <div class="alzatheme-pd-content-wrap">
                            <div class="alzatheme-service-details-item">
                                {!! clean($project->translate->description) !!}
                            </div>

                            <div class="alzatheme-pd-content-item">
                                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="alzatheme-pd-sidebar-wrap">
                            <div class="alzatheme-pd-sidebar">
                                <h5>{{ __('translate.Project Details') }}</h5>
                                <div class="alzatheme-pd-sidebar-item">
                            ...
                            <div class="alzatheme-service-contact" data-aos="fade-up" data-aos-duration="800">

                                <div class="alzatheme-service-contact-icon">
                                    <span>
                                ...
                                <a class="alzatheme-default-btn" href="{{ route('contact-us') }}" data-text="{{ getTranslatedValue($getSidebarCTAData,'button_text', $currentLang) }}"><span
            ...
            <div class="alzatheme-post-navigation2">
                @if($previousProject)
                    <a href="{{ route('portfolio.show', $previousProject->slug) }}" class="p-nav-previous">
                        <div class="alzatheme-post-icon">
                            <i class="ri-arrow-left-s-line"></i>
                        </div>
                        <div class="alzatheme-post-data">

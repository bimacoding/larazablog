...
@section('front-content')
    <header class="site-header alzatheme-header-section site-header--menu-right" id="sticky-menu">
        <div class="alzatheme-header-top dark-bg">
            <div class="container">
                    ...
                    <nav class="navbar site-navbar">
                        ...
                        <div class="header-btn header-btn-l1 ms-auto d-none d-xs-inline-flex">
                            <div class="alzatheme-header-icon">
                                ...
                                <div class="alzatheme-header-barger light-color">
                                    <span></span>
                                </div>
                            </div>
                        </div>
    ...
    <div class="alzatheme-sidemenu-wraper">
        <div class="alzatheme-sidemenu-column">
            <div class="alzatheme-sidemenu-body">
                ...
                <div class="alzatheme-contact-info-wrap mt-2">
    ...
    <div class="alzatheme-hero-section5" style="background-image: url({{ asset(getImage($heroContent, 'hero_image')) }})">
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-7 d-flex align-items-center">
                    <div class="alzatheme-hero-content white-color sm">
                        ...
                        <div class="alzatheme-extra-mt" data-aos="fade-up" data-aos-duration="600">
                            <a class="alzatheme-default-btn alzatheme-white-btn" href="{{ route('contact-us') }}" data-text="{{ getTranslatedValue($heroContent, 'left_button_text', $currentLang) }}">
                ...
                <div class="col-xl-4 col-lg-5" data-aos="fade-up" data-aos-duration="800">
                    <div class="alzatheme-hero-form">
                        ...
                        <form action="{{ route('store-contact-message') }}" method="post">
                            @csrf
                            <div class="alzatheme-main-field">
                            ...
                            <button id="alzatheme-main-form-btn" type="submit" data-text="{{ getTranslatedValue($heroContent, 'form_button_text', $currentLang) }}">
                                <span class="btn-wraper">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="600">
                    <div class="alzatheme-iconbox-wrap4">
                        <div class="alzatheme-iconbox-icon4">
                            <img src="{{ asset(getImage($keyContent,'image1')) }}" alt="">
                        </div>
                        <div class="alzatheme-iconbox-data4">
                            <h4>{{ getTranslatedValue($keyContent, 'heading_1', $currentLang) }}</h4>
                            <p>{{ getTranslatedValue($keyContent, 'description_1', $currentLang) }}</p>
                            <a class="alzatheme-icon-btn" href="{{ getTranslatedValue($keyContent, 'service_url_1', $currentLang) }}"><i class="icon-show ri-arrow-right-line"></i>
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="800">
                    <div class="alzatheme-iconbox-wrap4">
                        ...
                        <div class="alzatheme-iconbox-data4">
                            ...
                            <a class="alzatheme-icon-btn" href="{{ getTranslatedValue($keyContent, 'service_url_2', $currentLang) }}"><i class="icon-show ri-arrow-right-line"></i>
                                <span>{{ __('translate.Learn More') }}</span> <i class="icon-hide ri-arrow-right-line"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="1000">
                    <div class="alzatheme-iconbox-wrap4">
                        ...
                        <div class="alzatheme-iconbox-data4">
                            ...
                            <a class="alzatheme-icon-btn" href="{{ getTranslatedValue($keyContent, 'service_url_3', $currentLang) }}"><i class="icon-show ri-arrow-right-line"></i>
                                <span>{{ __('translate.Learn More') }}</span> <i class="icon-hide ri-arrow-right-line"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="alzatheme-default-content ml40">
                        ...
                        <div class="alzatheme-extra-mt">
                            <a class="alzatheme-default-btn" href="{{ getTranslatedValue($aboutUsContent, 'button_link', $currentLang) }}" data-text="{{ getTranslatedValue($aboutUsContent, 'button_text', $currentLang) }}">
    ...
    <div class="section alzatheme-section-padding bg-light1">
        <div class="container">
            ...
            <div class="alzatheme-4column-slider2" data-aos="fade-up" data-aos-duration="800">
                ...
                <div class="alzatheme-service-thumb alzatheme-service-thumb-tech">
    ...
    <div class="section alzatheme-section-padding5">
        <div class="container">
            <div class="alzatheme-section-title center">
            ...
            <div class="row z-index">
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="600">
                    <div class="alzatheme-numberbox-wrap">
                        <div class="alzatheme-numberbox-icon">
                            <img src="{{ asset(getImage($processContent,'image_1')) }}" alt="" class="full-img">
                        </div>
                        <div class="alzatheme-numberbox-data">
    ...
    <div class="section alzatheme-section-padding dark-bg">
        <div class="container">
    ...
    <div class="alzatheme-counter-section3">
        <div class="container">
            <div id="alzatheme-counter2"></div>
            <div class="alzatheme-counter-wrap3">
                <div class="alzatheme-counter-data3" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_1', $currentLang) }}">
                    <div class="alzatheme-counter-icon3">
                        <img src="{{ asset(getImage($counterContent, 'image_1')) }}" alt="">
                    </div>
                    <div class="alzatheme-counter-right">
                        <div class="alzatheme-counter-number3">
                            <span data-percentage="{{ getTranslatedValue($counterContent, 'counter_1', $currentLang) }}" class="alzatheme-counter"></span>+
                        </div>
                        <p>{{ getTranslatedValue($counterContent, 'title_1', $currentLang) }}</p>
                    </div>
                </div>
                <div class="alzatheme-counter-data3" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_2', $currentLang) }}">
                    <div class="alzatheme-counter-icon3">
                        <img src="{{ asset(getImage($counterContent, 'image_2')) }}" alt="">
                    </div>
                    <div class="alzatheme-counter-right">
                        <div class="alzatheme-counter-number3">
                            <span data-percentage="{{ getTranslatedValue($counterContent, 'counter_2', $currentLang) }}" class="alzatheme-counter"></span>+
                        </div>
                        <p>{{ getTranslatedValue($counterContent, 'title_2', $currentLang) }}</p>
                    </div>
                </div>
                <div class="alzatheme-counter-data3" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_3', $currentLang) }}">
                    <div class="alzatheme-counter-icon3">
                        <img src="{{ asset(getImage($counterContent, 'image_3')) }}" alt="">
                    </div>
                    <div class="alzatheme-counter-right">
                        <div class="alzatheme-counter-number3">
                            <span data-percentage="{{ getTranslatedValue($counterContent, 'counter_3', $currentLang) }}" class="alzatheme-counter"></span>+
                        </div>
                        <p>{{ getTranslatedValue($counterContent, 'title_3', $currentLang) }}</p>
                    </div>
                </div>
                <div class="alzatheme-counter-data3" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_4', $currentLang) }}">
                    <div class="alzatheme-counter-icon3">
                        <img src="{{ asset(getImage($counterContent, 'image_4')) }}" alt="">
                    </div>
                    <div class="alzatheme-counter-right">
                        <div class="alzatheme-counter-number3">
                            <span data-percentage="{{ getTranslatedValue($counterContent, 'counter_4', $currentLang) }}" class="alzatheme-counter"></span>%
                        </div>
    ...
    <div class="section alzatheme-section-padding">
        <div class="container">
            ...
            <div class="alzatheme-3column-slider2" data-aos="fade-up" data-aos-duration="800">
                @foreach($testimonials as $testimonial)
                <div class="alzatheme-t-box3 mb-0">
                    <div class="alzatheme-t-data3">
                        <div class="alzatheme-t-rating3">
                            <ul>
    ...
    <div class="section alzatheme-section-padding2 bg-light1">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-7 col-lg-5 d-flex align-items-center justify-content-end">
                        <div class="alzatheme-title-btn">
                            <a class="alzatheme-default-btn" href="{{ route('blogs') }}" data-text="{{ __('translate.View All Posts') }}"><span class="btn-wraper">{{ __('translate.View All Posts') }}</span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-duration="600">
                    <div class="alzatheme-blog-wrap2">
                        <div class="alzatheme-blog-thumb2">
                            <img src="{{ asset($blog->image) }}" alt="Image Blog">
                            <div class="alzatheme-blog-content2">
    ...
    <footer class="alzatheme-footer-section footer-v5">
        <div class="alzatheme-footer-form-section">
            <div class="container">
                <div class="alzatheme-footer-form-wrap">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="alzatheme-footer-form">
                                ...
                                <form action="{{ route('store-contact-message') }}" method="POST">
                                    ...
                                    <button id="alzatheme-main-form-btn" type="submit" data-text="{{ __('translate.Send Message') }}"> <span class="btn-wraper">{{ __('translate.Send Message') }}
                                        </span>
                                    </button>
                                </form>
                            </div>

...
@section('new-layout')
    ...
    <div class="section alzatheme-section-padding">
        <div class="container">
            <div class="alzatheme-team-single-wrap">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="alzatheme-team-single-thumb" data-aos="fade-up" data-aos-duration="800">
                            <img src="{{ asset($team->image) }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 offset-lg-1">
                        <div class="alzatheme-team-single-content">
                        ...
                        <div class="alzatheme-main-form p-0">

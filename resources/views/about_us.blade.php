                ...
                <div class="col-lg-6 d-flex align-items-center">
                    <div class="alzatheme-default-content ml40">
                        ...
                        <div class="alzatheme-extra-mt">
                            <a class="alzatheme-default-btn" href="{{ route('contact-us') }}" data-text="{{ getTranslatedValue($aboutUsContent, 'button_text', $currentLang) }}"><span class="btn-wraper">
        ...
        <div class="container">
            ...
            <div class="alzatheme-counter-wrap3">
                <div class="alzatheme-counter-data3" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_1', $currentLang) }}">
                    ...
                    <div class="alzatheme-counter-right">
                        <div class="alzatheme-counter-number3">
                            <span data-percentage="{{ getTranslatedValue($counterContent, 'counter_1', $currentLang) }}" class="alzatheme-counter">{{ getTranslatedValue($counterContent, 'counter_1', $currentLang) }}</span>+
                        </div>
                ...
                <div class="alzatheme-counter-data3" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_2', $currentLang) }}">
                    ...
                    <div class="alzatheme-counter-right">
                        <div class="alzatheme-counter-number3">
                            <span data-percentage="{{ getTranslatedValue($counterContent, 'counter_2', $currentLang) }}" class="alzatheme-counter">{{ getTranslatedValue($counterContent, 'counter_2', $currentLang) }}</span>+
                        </div>
                ...
                <div class="alzatheme-counter-data3" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_3', $currentLang) }}">
                    ...
                    <div class="alzatheme-counter-right">
                        <div class="alzatheme-counter-number3">
                            <span data-percentage="{{ getTranslatedValue($counterContent, 'counter_3', $currentLang) }}" class="alzatheme-counter">{{ getTranslatedValue($counterContent, 'counter_3', $currentLang) }}</span>+
                        </div>
                ...
                <div class="alzatheme-counter-data3" data-aos="fade-up" data-aos-duration="{{ getTranslatedValue($counterContent, 'counter_4', $currentLang) }}">
                    ...
                    <div class="alzatheme-counter-right">
                        <div class="alzatheme-counter-number3">
                            <span data-percentage="{{ getTranslatedValue($counterContent, 'counter_4', $currentLang) }}" class="alzatheme-counter">{{ getTranslatedValue($counterContent, 'counter_4', $currentLang) }}</span>%
                        </div>

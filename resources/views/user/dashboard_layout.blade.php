...
@section('new-layout')
                ...
                <div class="modal-body">
                    ...
                    <form class="d_change_password_box_form" action="{{ route('user.confirm-account-delete') }}" method="POST">
                        ...
                        <div class="d_profile_setting_from_item">
                            <div class="alzatheme-checkout-field">
                        ...
                        <div class="d_profile_setting_from_btn">
                            <button class="alzatheme-default-btn red" data-text="{{ __('translate.Delete Account') }}">
                                <span class="btn-wraper">{{ __('translate.Delete Account') }}</span>
                            </button>

                            <button class="alzatheme-default-btn two" type="button" data-text="{{ __('translate.Cancel') }}" data-bs-dismiss="modal">
                ...
                <div class="modal-body">
                    ...
                    <div class="d_profile_setting_from_btn">
                        <form method="get" action="{{ route('user.logout') }}">
                            @csrf
                            <button class="alzatheme-default-btn red" data-text="{{ __('translate.Logout') }}">
                                <span class="btn-wraper">{{ __('translate.Logout') }}</span>
                            </button>
                        </form>

                        <button class="alzatheme-default-btn two" data-text="Cancel" data-bs-dismiss="modal">
                            <span class="btn-wraper">{{ __('translate.Cancel') }}</span>
                        </button>
                    </div>
                </div>
    ...
    <header class="site-header alzatheme-header-section" id="sticky-menu">
        <div class="alzatheme-header-top bg-light1">
            <div class="container">
                <div class="alzatheme-header-info-wrap">
                    <div class="alzatheme-header-info dark-color ">
                        <ul>
                    ...
                    <div class="alzatheme-header-info-right two">

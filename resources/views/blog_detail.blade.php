...
<div class="section alzatheme-section-padding">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="alzatheme-blog-thumb single-blog" data-aos="fade-up" data-aos-duration="800">
                    <img src="{{ asset($blog->image) }}" alt="Blog Image">
                </div>
                <div class="alzatheme-single-post-content-wrap">
                    <div class="alzatheme-single-post-meta">
                        <ul>
                    ...
                    <div class="entry-content">
                        ...
                        <div class="alzatheme-single-post-tag-wrap">
                        ...
                        <div class="alzatheme-post-navigation">
                            @if($previous)
                        ...
                        <div class="alzatheme-post-comment">
                            <h3>{{ __('translate.Comments:') }}</h3>
                            <ul>
                                @foreach ($blog_comments as $blog_comment)
                                <li>
                                    <div class="alzatheme-post-comment-wrap">
                                        <div class="alzatheme-post-comment-thumb">
                                            <img src="{{ asset($general_setting->default_avatar) }}" alt="">
                                        </div>
                                        <div class="alzatheme-post-comment-data">
                                            <p>
                        ...
                        <div class="alzatheme-comment-box">
                            <h3>{{ __('translate.Leave a comments:') }}</h3>
                            <form action="{{ route('store-blog-comment', $blog->id) }}" method="POST">
                                @csrf
                                <div class="alzatheme-comment-box-form">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="alzatheme-comment-form">
                                                <input
                                                    type="text"
                                                    id="name"
                                                    name="name"
                                    ...
                                    <button id="alzatheme-default-btn" type="submit" data-text="Send Message">

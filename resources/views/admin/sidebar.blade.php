...
<div class="admin-menu__one crancy-sidebar-padding mg-top-20">
    ...
    <div class="menu-bar">
        <ul id="CrancyMenu" class="menu-bar__one crancy-dashboard-menu">
            ...
            @if (config('app.ecommerce_view_show', false))
                <li
                    ...
                    <div class="collapse crancy__dropdown {{ Route::is('admin.orders') || Route::is('admin.order') || Route::is('admin.active-orders') || Route::is('admin.reject-orders') || Route::is('admin.delivered-orders') || Route::is('admin.complete-orders') || Route::is('admin.pending-payment-orders') ? 'show' : '' }}"
                        ...
                        <ul class="menu-bar__one-dropdown">
                            ...
                            <li><a href="{{ route('admin.orders') }}"><span class="menu-bar__text"><span
                                            class="menu-bar__name">{{ __('translate.All Orders') }}</span></span></a>
                            </li>
                            ...
                            <li><a href="{{ route('admin.pending-payment-orders') }}"><span
                ...
                <li
                    ...
                    <div class="collapse crancy__dropdown {{ Route::is('admin.product.index') || Route::is('admin.product.create') || Route::is('admin.product.edit') || Route::is('admin.brand.*') || Route::is('admin.category.*') || Route::is('admin.sub-category.*') ? 'show' : '' }}"
                        ...
                        <ul class="menu-bar__one-dropdown">
                            ...
                            <li><a href="{{ route('admin.sub-category.index') }}"><span class="menu-bar__text"><span
                                            class="menu-bar__name">{{ __('translate.Sub Categories') }}</span></span></a>
                            </li>

                            <li><a href="{{ route('admin.brand.index') }}"><span class="menu-bar__text"><span
                                            class="menu-bar__name">{{ __('translate.Brand List') }}</span></span></a>
                            </li>
            ...
            <li
                class="{{ Route::is('admin.partners*') }}">
                <a href="#!" class="collapsed" data-bs-toggle="collapse"
                    data-bs-target="#menu-item__car_partner"><span class="menu-bar__text">
                        <span class="crancy-menu-icon crancy-svg-icon__v1">
                            <svg fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="34" height="34" viewBox="0 0 34 34" xml:space="preserve" >
                        ...
                        <span class="menu-bar__name">{{ __('translate.Manage Partner') }}</span></span> <span
                        class="crancy__toggle"></span></a></span>
                <!-- Dropdown Menu -->
                <div class="collapse crancy__dropdown {{ Route::is('admin.partners*') ? 'show' : '' }}"
                    id="menu-item__car_partner" data-bs-parent="#CrancyMenu">
                    <ul class="menu-bar__one-dropdown">

                        <li><a href="{{ route('admin.partners.create') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Create Partner') }}</span></span></a>
                        </li>

                        <li><a href="{{ route('admin.partners.index') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Partner List') }}</span></span></a>
                        </li>
            ...
            <li
                class="{{ Route::is('admin.listings*') || Route::is('admin.select-listing-purpose') || Route::is('admin.awaiting-listing') || Route::is('admin.review-list') || Route::is('admin.review-detail') || Route::is('admin.job-posts') ? 'active' : '' }}">
                <a href="#!" class="collapsed" data-bs-toggle="collapse"
                    data-bs-target="#menu-item__car_list"><span class="menu-bar__text">
                        ...
                        <span class="menu-bar__name">{{ __('translate.Manage Service') }}</span></span> <span
                        class="crancy__toggle"></span></a></span>
                <!-- Dropdown Menu -->
                <div class="collapse crancy__dropdown {{ Route::is('admin.listings*') ? 'show' : '' }}"
                    ...
                    <ul class="menu-bar__one-dropdown">
                        ...
                        <li><a href="{{ route('admin.listings.create') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Create Service') }}</span></span></a>
                        </li>
            ...
            <li
                class="{{ Route::is('admin.testimonial.*') || Route::is('admin.footer') || Route::is('admin.explore-section') || Route::is('admin.slider.*') ? 'active' : '' }}">
                <a href="#!" class="collapsed" data-bs-toggle="collapse"
                    data-bs-target="#menu-item__for_section"><span class="menu-bar__text">
                        ...
                        class="crancy__toggle"></span></a></span>
                <!-- Dropdown Menu -->
                <div class="collapse crancy__dropdown {{ Route::is('admin.slider.*') || Route::is('admin.testimonial.*') || Route::is('admin.footer') ? 'show' : '' }}"
                    id="menu-item__for_section" data-bs-parent="#CrancyMenu">
                    <ul class="menu-bar__one-dropdown">


                        <li><a href="{{ route('admin.slider.index') }}"><span class="menu-bar__text"><span
                                        class="menu-bar__name">{{ __('translate.Slider') }}</span></span></a></li>

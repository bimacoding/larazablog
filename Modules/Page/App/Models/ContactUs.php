...
class ContactUs extends Model
{
    ...
    public function getTitleAttribute()
    {
        ...
        return optional($this->front_translate)->title ?? '';
    }

    public function getDescriptionAttribute()
    {
        return optional($this->front_translate)->description ?? '';
    }

    public function getAddressAttribute()
    {
        return optional($this->front_translate)->address ?? '';
    }

    public function getContactDescriptionAttribute()
    {
        return optional($this->front_translate)->contact_description ?? '';
    }

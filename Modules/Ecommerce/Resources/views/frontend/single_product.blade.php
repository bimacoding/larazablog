...
@section('new-layout')
    ...
    <div class="section alzatheme-section-padding-top">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="alzatheme-tab-slider" data-aos="fade-up" data-aos-duration="800">
                        @if(count($product->galleries) > 0)
                            <div class="alzatheme-tabs-container">
                                <div class="alzatheme-tabs-wrapper">
                ...
                <div class="col-lg-6">
                    <div class="alzatheme-details-content">
                        <h2>{{ html_decode($pageTitle) }}</h2>
                        <h6>{!! $product->price_display !!}</h6>
                        <p>{!! clean($product->translate?->short_description) !!}</p>
                        <div class="alzatheme-product-wrap">
                            <div class="alzatheme-product-number">
                                <span class="alzatheme-product-minus minus quantity__minus"><i class="ri-subtract-line"></i></span>
                                    <input type="text" value="1" name="quantity" class="quantity__input"/>
                                <span class="alzatheme-product-plus plus quantity__plus"><i class="ri-add-line"></i></span>
                            </div>
                            <a class="alzatheme-product-btn cart-add-btn" href="javascript;" data-product-id="{{ $product->id }}" data-text="{{ __('translate.Add to Cart') }}">
                                <span class="btn-wraper">{{ __('translate.Add to Cart') }}</span>
                            </a>
                        </div>
                        <div class="alzatheme-product-info">
    ...
    <div class="section alzatheme-section-padding">
        <div class="container">
            <div class="alzatheme-product-tab">
                            ...
                            <div class="write_review_box">
                                ...
                                <div class="write_review_box_form_item">
                                    <div class="write_review_box_form_inner">
                                        <div class="alzatheme-checkout-field mb-0">
                                            <label>{{ __('translate.Write your message') }}</label>
                                            <textarea name="reviews" id="reviews" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <button type="button" class="alzatheme-default-btn" id="submit-review"
    ...
    @if($relatedProducts->isNotEmpty())
        <div class="alzatheme-related-product-section mt-5">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="400">
                    <div class="alzatheme-shop-wrap" id="wishlist-item-{{ $relateProduct->id }}">
                        <div class="alzatheme-shop-thumb">
                    ...
                    <a class="alzatheme-shop-btn cart-add-btn" data-product-id="{{ $relateProduct->id }}" data-text="Add to Cart"><span class="btn-wraper">{{ __('translate.Add to
                  Cart') }}</span></a>
                        </div>
                        <div class="alzatheme-shop-data">

        ...
        <div class="row">
            ...
            @else
                <form action="{{ route('checkout.process-to-payment') }}" method="GET">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="alzatheme-checkout-form">
                            <h5>{{ __('translate.Shipping Details') }}</h5>
                                ...
                                <div class="alzatheme-checkout-field dropdown">
                        ...
                        <div class="col-lg-5 offset-lg-1">
                            <div class="alzatheme-checkuot-sidebar-column">
                            <div class="alzatheme-checkuot-sidebar">
                                ...
                                @if($carts->isNotEmpty())
                                    <button class="alzatheme-default-btn shop-order-btn" type="submit" data-text="{{ __('translate.Place Order') }}">

...
Route::group(['as'=> 'admin.', 'prefix' => 'admin/ecommerce', 'middleware' => ['MaintenanceMode','ecommerce.enabled','auth:admin']], function () {
...
Route::group(['middleware' => ['HtmlSpecialchars', 'MaintenanceMode','ecommerce.enabled']], function () {

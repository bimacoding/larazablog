...
Route::group(['middleware' => [ 'HtmlSpecialchars', 'MaintenanceMode']], function () {
    ...
    Route::get('/showrooms', [HomeController::class, 'showrooms'])->name('showrooms');
    Route::get('/detil/{id}/showroom-detil', [HomeController::class, 'showRoomsDetil'])->name('showroomsdetil');
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::controller(UserController::class)->group(function () {
            Route::get('user-list', 'user_list')->name('user-list')->middleware('ecommerce.enabled');
            Route::get('pending-user', 'pending_user')->name('pending-user')->middleware('ecommerce.enabled');
            Route::get('user-show/{id}', 'user_show')->name('user-show')->middleware('ecommerce.enabled');
            Route::delete('user-delete/{id}', 'user_destroy')->name('user-delete')->middleware('ecommerce.enabled');
            Route::put('user-status/{id}', 'user_status')->name('user-status')->middleware('ecommerce.enabled');
            Route::put('user-update/{id}', 'update')->name('user-update')->middleware('ecommerce.enabled');

            Route::get('feez-profile/{id}', 'user_feez')->name('feez-profile')->middleware('ecommerce.enabled');
        });

(function($) {
    ...
    $(function() {
        ...
        optech PRELOADER JS INIT
        --------------------------------------------------------------*/
        $(".alzatheme-preloader-wrap").fadeOut(500);

        /*--------------------------------------------------------------
        optech HEADER SEARCH JS INIT
        ------------------------------------------------------------*/

        $(".alzatheme-header-search, .alzatheme-header-search-close, .search-overlay").on("click", function(e) {
            $(".alzatheme-header-search-section, .search-overlay").toggleClass("open").css("display", "");
        })
        ...
        optech MENU SIDEBAR JS INIT
        --------------------------------------------------------------*/
        $(".alzatheme-header-barger").on("click", function(e) {
            $(".alzatheme-sidemenu-column, .offcanvas-overlay").addClass("active");
            event.preventDefault(e);
        });
        $(".alzatheme-sidemenu-close, .offcanvas-overlay").on("click", function() {
            $(".alzatheme-sidemenu-column, .offcanvas-overlay").removeClass("active");
        });
        ...
        var hero_slider = $('.alzatheme-hero-slider');
        if (hero_slider.is_exist()) {
            hero_slider.slick({
                ...
                prevArrow: '<button class="slide-arrow alzatheme-hero-next"><i class="ri-arrow-left-s-line"></i></button>',
                nextArrow: '<button class="slide-arrow alzatheme-hero-prev"><i class="ri-arrow-right-s-line"></i></button>'
            }).slickAnimation();
        }
        ...
        optech FOUR COLUMN SLIDER INIT
        --------------------------------------------------------------*/
        var four_column_slider = $('.alzatheme-4column-slider');
        ...
        optech THREE COLUMN SLIDER INIT
        --------------------------------------------------------------*/
        var three_column_slider = $('.alzatheme-3column-slider');
        ...
        optech FOUR COLUMN SLIDER TWO INIT
        --------------------------------------------------------------*/
        var four_column_slider2 = $('.alzatheme-4column-slider2');
        ...
        optech TWO COLUMN SLIDER INIT
        --------------------------------------------------------------*/
        var two_column_slider = $('.alzatheme-2column-slider');
        ...
        optech ONE COLUMN SLIDER INIT
        --------------------------------------------------------------*/
        var t_one_column_slider = $('.alzatheme-1column-slider');
        if (t_one_column_slider.is_exist()) {
            t_one_column_slider.slick({
                ...
                autoplay: false,
                speed: 800,
                prevArrow: '<button class="slide-arrow alzatheme-t-next"><i class="ri-arrow-left-s-line"></i></button>',
                nextArrow: '<button class="slide-arrow alzatheme-t-prev"><i class="ri-arrow-right-s-line"></i></button>'
            });
        }
        ...
        optech THREE COLUMN SLIDER TWO INIT
        --------------------------------------------------------------*/
        var three_column_slider2 = $('.alzatheme-3column-slider2');
        ...
        optech BRAND SLIDER INIT
        --------------------------------------------------------------*/
        var optech_brand_slider = $('.alzatheme-brand-slider');
